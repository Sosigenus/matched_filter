...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "AMOUNT_COEF" -parent ${Page_0}
  ipgui::add_param $IPINST -name "DATA_WIDTH" -parent ${Page_0}


}

proc update_PARAM_VALUE.AMOUNT_COEF { PARAM_VALUE.AMOUNT_COEF } {
	# Procedure called to update AMOUNT_COEF when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.AMOUNT_COEF { PARAM_VALUE.AMOUNT_COEF } {
	# Procedure called to validate AMOUNT_COEF
	return true
}
...
proc update_MODELPARAM_VALUE.AMOUNT_COEF { MODELPARAM_VALUE.AMOUNT_COEF PARAM_VALUE.AMOUNT_COEF } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.AMOUNT_COEF}] ${MODELPARAM_VALUE.AMOUNT_COEF}
}
